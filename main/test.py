...
# python test.py --gpu 0 --test_epoch 19 --test_set test --annot_subset machine_annot
def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--gpu', type=str, dest='gpu_ids', default="0")
    parser.add_argument('--test_epoch', type=str, dest='test_epoch', default="12")
    parser.add_argument('--test_set', type=str, dest='test_set', default="test")
    parser.add_argument('--annot_subset', type=str, dest='annot_subset', default="machine_annot")
...
def main():
    ...
    # args = parse_args(test_epcoh,test_set,machine_annot)
    args = parse_args()
...
if __name__ == "__main__":
    ...
    main()
    # main("19",test_set,annot_subset)
    # main("18",test_set,annot_subset)
    # main("17",test_set,annot_subset)
    # main("16",test_set,annot_subset)
    # main("15",test_set,annot_subset)
    # main("14",test_set,annot_subset)
    # main("13",test_set,annot_subset)
    # main("12",test_set,annot_subset)
    # main("11",test_set,annot_subset)
